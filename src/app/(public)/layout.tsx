import Header from "@/app/(public)/Components/header/header";
import {SidebarInset, SidebarProvider, SidebarTrigger} from "@/components/ui/sidebar";
import {AppSidebar} from "@/app/(public)/Components/sidebar/app-sidebar";
                        ...
                        <Breadcrumb>
                            <BreadcrumbList>
                                <BreadcrumbItem className="hidden md:block">
                                    <BreadcrumbLink href="/Dashboard/id">Dashboard</BreadcrumbLink>
                                </BreadcrumbItem>
